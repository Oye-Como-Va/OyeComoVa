        ...
        @if (count($course->subjects) > 0)
            <div class="card-body">
                ...
                <p class="card-text">
                    @foreach ($course->subjects as $subject)
                        <p><i class='bx bxs-palette' style="color: {{ $subject->color }}"></i></box-icon></span>
                            {{ $subject->name }}</p>
                    @endforeach
                </p>
            ...
            @else
                <div class="card-body">
                    ...
                    <a href="#" class="card-link" href="#modallink{{ $course->id }}" data-bs-toggle="modal"
                        data-bs-target="#modallink{{ $course->id }}">
                        ¿Desea crearla?
                    </a>
                    <div class="modal fade" id="modallink{{ $course->id }}" data-bs-backdrop="static"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('create_subject') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="qualification">Calificacion</label>
                                            <input type="num" class="form-control" id="qualification"
